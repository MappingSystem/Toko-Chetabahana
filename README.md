...
## Repositori
Repositori ([_Repo_](https://help.github.com/articles/create-a-repo/)) disetel [srtukturnya](#srtuktur) via [_remote_](https://git-scm.com/book/en/v2/Git-Basics-Working-with-Remotes) atau [_symlink_](https://github.com/MarketLeader/gh-pages-symlink-test) ke target sbb:
