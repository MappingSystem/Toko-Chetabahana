...
- Proses ke-1: Pengelolaan terhadap hasil [_Optimasi Internal_](https://chetabahana.blogspot.com/) toko dari [_sesi yg pertama_](https://chetabahana.blogspot.com/) via [Google Sites API](https://developers.google.com/google-apps/sites/docs/developers_guide).
