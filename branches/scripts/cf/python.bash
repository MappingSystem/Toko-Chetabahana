...
cd Toko-Chetabahana && cp -f /workspace/scripts/branches.log logs/
rm -rf branches && cp -frpT /workspace branches
rm -rf branches/.git branches/home/chetabahana/.ssh
git add . && git commit -m "sync branches"
git push -u origin master

rm -rf $HOME/Toko-Chetabahana
eval `ssh-agent -k`
